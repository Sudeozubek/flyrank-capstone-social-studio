...
- **Platform-tailored captions** — generated by this project's prompt pipeline (shared brand
  voice + per-platform fragments) with an LLM as the writing step; deterministic composer as
  fallback. Brand name and brand tone are optional campaign inputs.
